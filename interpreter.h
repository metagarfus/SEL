...
typedef external_interpreter (* get_external_interpreter)(interpreter_context *context, void *opaque, const char* name);
...
data_result interpreter_run(interpreter_config *config, external_context external, const tag_tuple *tagtuple);
